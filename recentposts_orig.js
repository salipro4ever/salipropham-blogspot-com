...
*  Script by bloggerplugins.org
*  Re-layout by SaliproIT
*  Site: http://salipropham.blogspot.com
*/ 
...
var s;
    ...
    code = "";
		...
		//SaliproIT:  Them container cho moi items
		contDiv = document.createElement('div'); 
		contDiv.setAttribute("class", "recent-post-cont");  
 ...
 try {
    ...
    if (flag == 1) contDiv.appendChild(myDiv);
